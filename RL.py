...
class Game:
    ...
    def setTimers(self):
        pygame.time.set_timer(slow,
                              SLOW)  # movement for slow enemies every time this goes off slow enemies are allowed to move
    ...
    def slowTimers(self):
        pygame.time.set_timer(slow,
                              SLOW + 500)  # movement for slow enemies every time this goes off slow enemies are allowed to move
    ...
    def stopTimers(self):
        pygame.time.set_timer(slow,
                              OFF)  # movement for slow enemies every time this goes off slow enemies are allowed to move
